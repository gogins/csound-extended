...
This file contains instrument definitions that require Windows, some 
SoundFonts, and the vst4cs opcodes. This file should also 
run "as is" in CsoundVST in VST hosts, or to receive MIDI.
...
gkMasterLevel                   init                    0.000001
                                ...
                                connect                 "FluidAudio",           "outleft", 	"Reverberation",        "inleft"
                                connect                 "FluidAudio",           "outright", "Reverberation",        "inright"
                                ...
                                connect                 "VstPianoteqAudio",     "outleft", 	"Reverberation",        "inleft"
                                connect                 "VstPianoteqAudio",     "outright", "Reverberation",        "inright"
...
p3                              =                       isustain + iattack + irelease
adeclick                        linsegr                 0.0, iattack, 1.0, isustain, 1.0, irelease, 0.0
aoutleft, aoutright             pan2                    iamplitude * asignal * adeclick, .75;i_pan
                                outleta                 "outleft",  aoutleft
                                outleta                 "outright", aoutright
                                endin
...
aoutleft			            = 			            i_midivelocity * aoutleft * 10000
aoutright			            =			            i_midivelocity * aoutright * 10000
                                outleta                 "outleft", aoutleft
                                outleta                 "outright", aoutright
                                endin
