...
# LOCAL_CXX := "g++ -m32"
LOCAL_C_INCLUDES := $(NDK_MODULE_PATH) $(NDK_MODULE_PATH)/luajit-2.0/src $(CSOUND_SRC_ROOT)/Engine $(CSOUND_SRC_ROOT)/H $(CSOUND_SRC_ROOT)/include $(NDK_MODULE_PATH)/libsndfile-android/jni 
