...
The chord space facility in Csound AC has been very useful to me over the years but recently I took at look at the "chord space group" facility and discovered many bugs in the underlying chord symmetry code, based on the work of Callender, Quinn, and Tymoczko. I have now discovered and, I hope, corrected all major incorrect assumptions and algorithms. The predicates and transformations for octave equivalence (O), permutational equivalence (P), transpositiional equivalence (T), and inversional equivalence (I) has been throughly reviewed. The predicates and transformations for the I, OPT, and OPTI equivalence relations have been rewritten to take into account the cyclical region of OPT and OPTI fundamental domains. This has included deriving the fundamental domains from first principles and implementing the inversion flats in each OPT sector of the cyclical region using linear algebra. All of this work has been subjected to comprehensive unit tests.
