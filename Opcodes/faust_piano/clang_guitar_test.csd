...
<CsOptions>
-m165 -otemp.wav -m195 -Fbachfug.mid --midi-key=4 --midi-velocity=5 --terminate-on-midi --opcode-lib="/home/mkg/clang-opcodes/clang_opcodes.so"
</CsOptions>
...
i_result clang_compile "guitar_main", S_guitar_source_code, "-DUSE_DOUBLE -Dlinux --std=gnu++17 -lstdc++fs -Wno-write-strings -Ofast -march=native -I/usr/local/include/csound -I. -stdlib=libstdc++", "/usr/lib/gcc/x86_64-linux-gnu/9/libstdc++.so /usr/lib/gcc/x86_64-linux-gnu/9/libgcc_s.so /usr/lib/x86_64-linux-gnu/libm.so /usr/lib/x86_64-linux-gnu/libpthread.so"
