...
clang++ -v -Xlinker -g -O2 -fPIC -Wl,-export-dynamic -shared `llvm-config --cxxflags --ldflags` -I/usr/local/include -I/usr/local/include/csound clang_orc_opcode.cpp $CLANGLIBS2 `llvm-config --libs --system-libs` -o clang_orc_opcode.so
ls -ll
