...
public:
  /**
   * Opcode return value, the score generated by cmask from the parameters.
   */
  STRINGDAT *score;
  /**
   * The text of the CMask parameters, just as in a standard CMask parameters file.
   */
  STRINGDAT *parameters_text;
  /**
   * If true (the default), immediately schedule the generated score for performance.
   */
  MYFLT *play_immediately;
  /**
   * At i-time, call the CMask scanner and analyzer to generate Csound score events 
