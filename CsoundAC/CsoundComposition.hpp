 ...
 */
#ifndef CSOUNDCOMPOSITION_H
#define CSOUNDCOMPOSITION_H
...
namespace csound
{
   ...
   * via the CsoundThreaded class.
   */
  class SILENCE_PUBLIC CsoundComposition :
    public ScoreModel,
    public CsoundFile
  {
  public:
    CsoundComposition();
    virtual ~CsoundComposition();
     ...
     */
    virtual void setCsoundThreaded(CsoundThreaded *orchestra);
    /**
     * Return the self-contained Orchestra.
     */
    virtual CsoundThreaded *getCsoundThreaded();
    /**
     * Set the Csound orchestra
     * (convenience wrapper for CsoundThreaded::setOrchestra()).
     */
    virtual void setCsoundOrchestra(std::string orchestra);
    /**
     * Return the Csound orchestra
     * (convenience wrapper for CsoundThreaded::getOrchestra()).
      */
   ...
   /**
     ...
     * (convenience wrapper for CsoundThreaded::setCommand()).
     */
    virtual void setCsoundCommand(std::string command);
    /**
     * Return Csound command line
     * (convenience wrapper for CsoundThreaded::getCommand()).
     */
