 ...
 * indicated number of scale degrees.
 * PLEASE NOTE: This only works if the chord already belongs to the scale! 
 * However, the original chord may be in any order or voicing. It is assumed 
 * that the chords are generated by thirds. If the original chord does not 
 * belong to the scale, the original chord is returned in scale order.
 */
