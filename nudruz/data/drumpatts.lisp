...
(define elvin '((ride 0 1 2 2.6666 3 4 5 5.666)
		(sn 0 .3333 1.6666 2.3333 3 3.3333 4.6666 5.3333)
		(bd 0.6666 1.33333 2 4 5.66666)
		(hhc 1 2.66666 3.666666 4.333333 5)))

;; works well at .5
(define maxroach '((sn 0 3 6)
		(bd 1 2 3.5 5.5 6.5 7.5)
		(hhc .5 2.5 4 5 7)
		(tom1 1.5)
		(tom2 4.5)))

(define blakey-1 '((sn .3333 .6666 1 1.3333 1.6666 2.333 3 3.666)
		   (tom2 0 2 3.3333)
		   (hhc 1 3)))

(define blackwell '((sn 0 1.5)
		    (ride .5 1 2 3 3.5)
		    (tom1 2.5)
		    (bd .5 1 2 3 3.5)))

(define tony '((sn 0 .3333 1.5 2 2.3333 2.6666 3.5)
		 (ride .6666 1 3)
		 (bd .6666 1 3)))
...
(define speed-metal-1 '((hho 0 1 2 3)
		      (sn 1 3)
		      (bd 0 2)))

(define speed-metal-2 '((hho 0 1 2 3)
		      (sn 0 1 2 3)
		      (bd .5 1.5 2.5 3.5)))

;; example of run-time choices
; (define mything (new cycle :of (list 1 2 (pval (pick 4 6)))))
